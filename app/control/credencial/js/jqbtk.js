...
(function($) {
    $.fn.keyboard = function(options) {
        ...
        var settings = $.extend({
            ...
            btnClasses: 'btn btn-default btn-lg',
            btnActiveClasses: 'active btn-primary btn-lg',
            initCaps: false,
            placement: 'bottom',
            container:'body',
            trigger: 'focus'
        ...
        $(document).off('touchstart', '.jqbtk-row .btn-lg');
        $(document).on('touchstart', '.jqbtk-row .btn-lg', onKeypress);

        $(document).off('mousedown', '.jqbtk-row .btn-lg');
        $(document).on('mousedown', '.jqbtk-row .btn-lg',function(e){
        ...
        $(document).off('mouseup', '.jqbtk-row .btn-lg');
        $(document).on('mouseup', '.jqbtk-row .btn-lg',function(e){
            $(this).removeClass(settings.btnActiveClasses);
            var parent = $('[aria-describedby=' + $(this).closest('.popover').attr('id') + ']');
            parent.focus();
        });

        $(document).on('click', '.jqbtk-row .btn-lg',function(e){
            var parent = $('[aria-describedby=' + $(this).closest('.popover').attr('id') + ']');
            parent.focus();
        });
        $(document).on('touchend', '.jqbtk-row .btn-lg', function() {
            $(this).removeClass(settings.btnActiveClasses);
            var parent = $('[aria-describedby=' + $(this).closest('.popover').attr('id') + ']');
            parent.focus();
        });
