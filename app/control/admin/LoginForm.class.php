...
class LoginForm extends TPage
{
    ...
    function __construct($param)
    {
        ...
        $btn->class = 'btn bg-blue';
        $btn->style = 'height: 40px;width: 80%;display: block;margin: auto;font-size:17px;border-radius:10px';
        
        $wrapper = new TElement('div');
        $wrapper->style = 'margin:auto; margin-top:100px;max-width:460px;border-radius:100px;background:red;';
        $wrapper->id    = 'login-wrapperr';
